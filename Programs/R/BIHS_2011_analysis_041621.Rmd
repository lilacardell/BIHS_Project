...
ggplot(hh_BMI_workervisits_num,aes(num_visited_sixmo,BMI))+geom_boxplot(aes(group=num_visited_sixmo))+ylim(10,30)+xlab("Number of Health Worker Visits in the past six months")+ylab("Average HH BMI for children under 18")
...
# task: add an abline
ggplot(hh_kcal_workervisits_num,aes(num_visited_sixmo,actual_inadequate_FAO_grp))+geom_jitter(aes(group=num_visited_sixmo))+xlab("Number of Health Worker Visits in the past six months")+ylab("Actual Caloric Inadequcy")
...
ggplot(hh_hhds_workervisits_num,aes(num_visited_sixmo,factor(hhds)))+geom_jitter(aes(group=num_visited_sixmo))
