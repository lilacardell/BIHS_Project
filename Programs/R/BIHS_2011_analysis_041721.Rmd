...
# task: add an abline
ggplot(hh_kcal_workervisits_num,aes(num_visited_sixmo,actual_inadequate_FAO_grp))+geom_jitter(aes(group=num_visited_sixmo))+xlab("Number of Health Worker Visits in the past six months")+ylab("Percentage of Children with Caloric Inadequcy")+ geom_smooth(method = "lm", se = FALSE) +theme_minimal()
