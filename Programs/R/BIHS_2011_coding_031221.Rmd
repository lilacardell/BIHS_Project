...
CHW_visit = y8_female_2011%>%
  ...
  rename(hhid = a01, visit_sixMon = y8_01, health_org = y8_02, num_visited_sixMon = y8_03, any_advice = y8_04, advice1 = y8_05_1,advice2 = y8_05_2,advice3 = y8_05_3,advice4 = y8_05_4, any_grpDiscuss = y8_06, discuss_topics1 = y8_07_1,discuss_topics2 = y8_07_2,discuss_topics3 = y8_07_3,discuss_topics4 = y8_07_4)
...
#   mutate_at(.vars = c("i1_01","i1_02","i1_03","i1_04", "i1_05", "i1_06","i1_07","i1_08","i1_09a","i1_09b","i1_10","i1_11","i1_12a","i1_12b","i1_13","i1_14","i1_15"), funs(ifelse((is.na(Ag_production$.)), Ag_production$.,0)))
...
latrine_water = r_male_2011%>%
  ...
  rename(hhid = a01, latrine_type = r01, waterSource_othPurposes = r03)
...
social_safety = u_male_2011%>%
  ...
  rename(hhid = a01, slno_safetyNet = slno, any_assist = u01, cash_received = u02, rice_kg = u03, rice_valPerkg = u04, wheat_kg = u05, wheat_tkPerkg = u06, othfood_valtk = u07, othik_valtk = u08)

```

1.6 Merge selected variables with w.I.roster.2011
```{r}
...
#import weights
weights_2011 <- read_dta("D:/SP21/BIHSgit/BIHS_Project/Data/Raw Data/bihs_2011_2012/IFPRI_BIHS_R1_expenditure.dta") %>%
